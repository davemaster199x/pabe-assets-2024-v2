...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::middleware(['check.referrer:add_assets'])->group(function () {
        ...
        Route::post('/sites/update', [SiteController::class, 'store'])->name('sites.update');
        //load sites via api
        ...
        Route::post('/locations/update', [LocationController::class, 'store'])->name('locations.update');
        ...
        Route::post('/departments/update', [DepartmentController::class, 'store'])->name('departments.update');
        ...
        Route::post('/categories/update', [CategoryController::class, 'store'])->name('categories.update');
