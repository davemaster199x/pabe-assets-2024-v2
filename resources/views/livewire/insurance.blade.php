    <div>
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newInsuranceModal">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="newInsuranceModalLabel">New Insurance Policy</h5>
...
<script>
    ...
    document.addEventListener('livewire:load', function () {
        ...
        Livewire.on('testemit', function () {
            console.log('Nag console sya');
        });
    });
    // Livewire.on('fundingSaved', data => {
    //     console.log('Funding Saved:', data.fundingName);
    //     swal(
    //             "Success!", "Na saved na!", "success"           
    //         )
    // });
</script>
@endsection
